...
- Cart Items quantity can be increased or decreased.
- User can place order from cart and view order details.
...
## Install Project
    ...
    $ git clone https://github.com/imdivyachoudhary/BuyBusy.git
    $ cd BuyBusy
    $ yarn install
